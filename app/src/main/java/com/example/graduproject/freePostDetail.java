...
public class freePostDetail extends AppCompatActivity {
    CircleImageView detailImage;
    TextView detailWriter, detailTime, detailTitle, detailContent, typeFree;
    ...
    public boolean onKeyDown(int keycode, KeyEvent event) {
        if(keycode ==KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(freePostDetail.this, free.class));
            finish();
            return true;
        }
        return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_post_detail);
        ...
        detailImage =  findViewById(R.id.detailImageFree);
        detailWriter = findViewById(R.id.detailWriterFree);
        detailTime = findViewById(R.id.detailTimeFree);
        detailTitle = findViewById(R.id.detailTitleFree);
        detailContent = findViewById(R.id.detailContentFree);
        commentLists = findViewById(R.id.commentListsFree);
        commentInput = findViewById(R.id.commentInputFree);
        commentRegister = findViewById(R.id.commentRegisterFree);
        detailIng = findViewById(R.id.detailIngFree);
        detailClose = findViewById(R.id.detailCloseFree);
        ...
        mDatabaseRef.child("allPosts").child("free").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(pathRef!=null) { //profile.getProfileImageUrl() != null
                    pathRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Glide.with(freePostDetail.this).load(uri).into(detailImage);

                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Glide.with(freePostDetail.this).load(R.drawable.no_profile_image).into(detailImage);
                        }
                    });
                ...
                //무슨주제
                typeFree.setText(postModel.getType());
                ...
                mDatabaseRef.child("allPosts").child("free").child(key).child("comment").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        detailIng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(freePostDetail.this);
                builder.setTitle("모집완료").setMessage("모집을 완료하시겠어요?").setCancelable(true);
                builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        mDatabaseRef.child("allPosts").child("free").child(key).child("recruit").setValue(false);
                        detailIng.setVisibility(View.GONE);
                        detailClose.setVisibility(View.VISIBLE);
                        commentRegister.setVisibility(View.INVISIBLE);
                        commentInput.setFocusable(false);
                                        ...
                                        mDatabaseRef.child("userInfo").child(destUid).addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                ...
                                                builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                                                    @Override
                                                    public void onClick(DialogInterface dialogInterface, int i) {
                                                        Intent intent = new Intent(freePostDetail.this, ChatFunction.class);
