...
public class exercisePostDetail extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keycode, KeyEvent event) {
        if(keycode ==KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(exercisePostDetail.this, exercise.class));
            finish();
            return true;
        }
        return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_post_detail);
        ...
        detailImage =  findViewById(R.id.detailImageExer);
        detailWriter = findViewById(R.id.detailWriterExer);
        detailTime = findViewById(R.id.detailTimeExer);
        detailTitle = findViewById(R.id.detailTitleExer);
        detailDateInput = findViewById(R.id.detailDateInputExer);
        detailPeopleInput = findViewById(R.id.detailPeopleInputExer);
        detailGenderInput = findViewById(R.id.detailGenderInputExer);
        detailContent = findViewById(R.id.detailContentExer);
        commentLists = findViewById(R.id.commentListsExer);
        commentInput = findViewById(R.id.commentInputExer);
        commentRegister = findViewById(R.id.commentRegisterExer);
        detailIng = findViewById(R.id.detailIngExer);
        detailClose = findViewById(R.id.detailCloseExer);
        typeExer = findViewById(R.id.typeExer);
        ...
        mDatabaseRef.child("allPosts").child("exercise").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(pathRef!=null) { //profile.getProfileImageUrl() != null
                    pathRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Glide.with(exercisePostDetail.this).load(uri).into(detailImage);

                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Glide.with(exercisePostDetail.this).load(R.drawable.no_profile_image).into(detailImage);
                        }
                    });
                ...
                //무슨운동
                typeExer.setText(postModel.getType());
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        mDatabaseRef.child("allPosts").child("exercise").child(key).child("recruit").setValue(false);
                        detailIng.setVisibility(View.GONE);
                        detailClose.setVisibility(View.VISIBLE);
                        commentRegister.setVisibility(View.INVISIBLE);
                        commentInput.setFocusable(false);
