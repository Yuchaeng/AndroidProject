...
public class mealWrite extends AppCompatActivity {
    private TextView dateText;
    private DatePickerDialog datePickerDialog;
    private RadioButton selectDate,noSelect, schoolMeal, eatGood;
    ...
    public boolean onKeyDown(int keycode, KeyEvent event) {
        if(keycode == android.view.KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(mealWrite.this, meal.class));
            finish();
            return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateText = findViewById(R.id.dateTextMeal);
        selectDate = findViewById(R.id.selectDateMeal);
        noSelect = findViewById(R.id.noSelectMeal);
        timeSpinner = findViewById(R.id.timeSpinnerMeal);
        peopleSpinner = findViewById(R.id.countSpinnerMeal);
        genderSpinner = findViewById(R.id.genderSpinnerMeal);
        register = findViewById(R.id.registerMeal);
        inputTime = findViewById(R.id.inputTimeMeal);
        inputTitle = findViewById(R.id.inputTitleMeal);
        inputContent = findViewById(R.id.inputContentMeal);
        schoolMeal = findViewById(R.id.schoolMeal);
        eatGood = findViewById(R.id.eatGood);
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(mealWrite.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //학식 저장
                if(schoolMeal.isChecked()) {
                    typeSelect = schoolMeal.getText().toString();
                }
                else {
                    typeSelect = eatGood.getText().toString();
                }
                ...
                mDatabaseRef.child("userInfo").child(writerUid).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        mDatabaseRef.child("allPosts").child("meal").push().setValue(post);
                ...
                Toast.makeText(mealWrite.this, "게시글이 등록되었습니다.", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(mealWrite.this, meal.class);
