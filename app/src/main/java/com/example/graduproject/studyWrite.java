...
public class studyWrite extends AppCompatActivity {
    private TextView dateText;
    private DatePickerDialog datePickerDialog;
    private RadioButton selectDate,noSelect;
    private RadioGroup radioStudy;
    ...
    public boolean onKeyDown(int keycode, KeyEvent event) {
        if(keycode == android.view.KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(studyWrite.this, study.class));
            finish();
            return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_write);

        dateText = findViewById(R.id.dateTextStudy);
        selectDate = findViewById(R.id.selectDateStudy);
        noSelect = findViewById(R.id.noSelectStudy);
        timeSpinner = findViewById(R.id.timeSpinnerStudy);
        peopleSpinner = findViewById(R.id.countSpinnerStudy);
        genderSpinner = findViewById(R.id.genderSpinnerStudy);
        register = findViewById(R.id.registerStudy);
        inputTime = findViewById(R.id.inputTimeStudy);
        inputTitle = findViewById(R.id.inputTitleStudy);
        inputContent = findViewById(R.id.inputContentStudy);
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(studyWrite.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //공부 저장
                int checkedRadio = radioStudy.getCheckedRadioButtonId();
                ...
                mDatabaseRef.child("userInfo").child(writerUid).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        mDatabaseRef.child("allPosts").child("study").push().setValue(post);
                ...
                Toast.makeText(studyWrite.this, "게시글이 등록되었습니다.", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(studyWrite.this, study.class);
